...
const НАБОРЫ=[
 ['спокойный', {volt:.5,bak:.5,sway:.55,tone:.5,depth:.75,pulse:.2,hit:.35,spread:.15,
  drift:.2,range:.5,gryzn:.3,golos:.6,gen1:1,gen2:1,gen3:1,link:0,dirt:.2,petlya:0,
  kuda:0,naruzhu:0,zhat:0,drive:.15,master:1,pit:1,set:0,sboy:0,gnut:0,derzhi:0,takt:.5,razved:0}],
 ['крайний',   {volt:.5,bak:.5,sway:.7,tone:.3,depth:1,pulse:.5,hit:.6,spread:.8,
  drift:.5,range:.3,gryzn:.6,golos:1,gen1:1,gen2:1,gen3:1,link:.3,dirt:.5,petlya:0,
  kuda:.5,naruzhu:0,zhat:.4,drive:.5,master:1,pit:0,set:1,sboy:0,gnut:.4,derzhi:0,takt:.8,razved:0}],
];
