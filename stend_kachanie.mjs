...
// требование на панели. Мерится скорость ухода периода, процентов в секунду.
...
function progon(mix, shag){
  const c = new K();
  c.port.onmessage({data:{t:'seed', v:1626943591, p:{sway:.55, depth:.75,
    gryzn:0, golos:0, petlya:0, kuda:0, mix, zhat:0,
    master:.5}}});
