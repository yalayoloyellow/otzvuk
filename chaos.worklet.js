...
class Device {
  ...
  step(p, utechka, navodka, kontakt, gls, ogib, petl){
    ...
    //
    // ЗАКОН ХОДА — КУБ, и это тоже замер, а не вкус. Просадка идёт круто:
    //
    //     ход        0.00  0.20  0.35  0.50  0.70  0.85  1.00
    //     квадрат      96    59    34    21    14    12    11
    //     куб          96    93    78    49    22    14    11
    //     четвёртая    96    95    93    77    35    16    11
    //
    // При квадрате всё интересное умещается в первой пятой части хода, при
    // четвёртой — в последней трети. Куб раскладывает просадку ровно: начало
    // хода честно ничего не меняет, дальше шина сходит вниз без обрывов.
    this.bat.Rstarve = 2600 * clamp(p.starve || 0, 0, 1) ** 3;
