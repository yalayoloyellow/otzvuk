...
const БАЗА={volt:.5,bak:.5,sway:.55,tone:.5,depth:.75,pulse:.2,hit:.35,spread:.5,
 drift:0,range:.5,gryzn:0,golos:0,gen1:1,gen2:1,gen3:1,link:0,dirt:0,petlya:0,
 kuda:.5,naruzhu:0,zhat:0,drive:.15,master:1,pit:1,set:0,sboy:0,gnut:0,derzhi:0,takt:0};
const ВХ=900;
